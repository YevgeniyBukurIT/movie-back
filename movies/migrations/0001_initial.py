    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('budget', models.PositiveSmallIntegerField(default=0, help_text='enter the dollar amount', verbose_name='Budget')),
                ('feed_in_usa', models.PositiveSmallIntegerField(default=0, help_text='enter the dollar amount', verbose_name='Amount in USA')),
                ('feed_in_world', models.PositiveSmallIntegerField(default=0, help_text='enter the dollar amount', verbose_name='Amount in USA')),
